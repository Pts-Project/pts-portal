            ...
            <div class="row">
              <div class="col-md-4">
                <div class="profile-img">
                  <img src={profilepic} alt="profile" width="110px" />
                  ...
                  <Nav variant="pills" className="flex-column tabOption">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="addUser">
                        <i className="material-icons prefix">person_add</i>Add
                        User
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="allUser">
                        <i className="material-icons prefix">contacts</i>All
                        User
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="deleteUser">
                        <i className="material-icons prefix">delete_sweep</i>
                        Delete User
                      </Nav.Link>
                    </Nav.Item>
                    <label>Events</label>
                    <Nav.Item>
                      <Nav.Link eventKey="allEvents">
                        <i className="material-icons prefix">event</i>All Events
                      </Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                            ...
                            <p align="left" color="black">
                              <ul type="disc">
                                <div className="skillcontainer">
                                  <div class="skills A">Web Designer</div>
                                </div>
                                <div className="skillcontainer">
                                  <div class="skills B">Web Developer</div>
                                </div>
                                <div className="skillcontainer">
                                  <div class="skills D">WordPress</div>
                                </div>
                                <div className="skillcontainer">
                                  <div class="skills C">Biz Dev</div>
                                </div>
                                <div className="skillcontainer">
                                  <div class="skills A">Graphic Designing</div>
                                </div>
                              </ul>
                            </p>
                          </div>
